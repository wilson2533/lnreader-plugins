    ...
    RLIB.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.apiSite).concat(novelPath, "?fields[]=summary&fields[]=genres&fields[]=tags&fields[]=teams&fields[]=authors&fields[]=status_id&fields[]=artists"), { headers: __assign(__assign({}, (_a = this.user) === null || _a === void 0 ? void 0 : _a.token), { 'Site-Id': '3' }) }).then(function (res) { return res.json(); })];
                    case 1:
                        data = (_l.sent()).data;
                        novel = {
                            path: novelPath,
